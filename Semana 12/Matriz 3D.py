...
for i, ciudad in enumerate(temperaturas, start=1):  # Recorremos cada ciudad
    print(f"\n--- Ciudad {i} ---")
    for j, semana in enumerate(ciudad, start=1):    # Recorremos cada semana
        suma = 0
        for dia in semana:                          # Recorremos los días
            suma += dia["temp"]
        promedio = suma / len(semana)
        print(f"Semana {j}: Promedio = {promedio:.2f}°")
